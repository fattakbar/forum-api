...
describe('/authentications endpoint', () => {
  ...
  describe('when POST /authentications', () => {
    ...
    it('should response 400 if login payload not contain needed property', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('must submit username and password');
    });
  ...
  describe('when PUT /authentications', () => {
    ...
    it('should return 400 payload not contain refresh token', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('should send a refresh token');
    });
    ...
    it('should return 400 if refresh token not string', async () => {
      ...
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual(
        'refresh token must be of type string data',
      );
    });
    ...
    it('should return 400 if refresh token not registered in database', async () => {
      ...
      const refreshToken = await container
        ...
        .createRefreshToken({ username: 'akbar' });
